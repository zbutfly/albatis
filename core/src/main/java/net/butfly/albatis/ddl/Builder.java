...
public abstract class Builder {
	public static FieldDesc field(String fieldname, Map<String, ?> ops) {
		Object val;
		return new FieldDesc(fieldname, type(ops), (null != (val = ops.remove("rowkey")) ? Boolean.parseBoolean(val.toString()) : false))
				.attw(ops);
	}

	public static FieldDesc field(String fieldname, String desc) {
