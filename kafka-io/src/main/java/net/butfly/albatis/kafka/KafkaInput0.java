...
//
//@Deprecated
//public final class KafkaInput0 extends KafkaInputBase0<ReentrantLock> {
//	public KafkaInput0(String name, final String config, String... topics) throws ConfigException, IOException {
//		super(name, config, topics);
