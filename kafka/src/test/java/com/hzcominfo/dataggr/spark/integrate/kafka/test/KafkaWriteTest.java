...
import com.hzcominfo.dataggr.spark.integrate.SparkClient;
...
public class KafkaWriteTest {
	...
	public static void main(String[] args) {
		...
		SparkClient client = new SparkClient("kafka-apptest", uri);
			...
			public void process(Row row) {
				...
				for (String fn : fieldNames) {
					if ("value".equals(fn)) {
						...
						/*
						 * Object object; try { object = BytesUtils.byteToObject(bytes); } catch (ClassNotFoundException e) { throw new
						 * RuntimeException("classnotfound: " + e); } catch (IOException e) { throw new RuntimeException("io: " + e); }
