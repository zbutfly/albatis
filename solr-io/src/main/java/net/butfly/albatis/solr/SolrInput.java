...
//
// public SolrInput(final String solrZookeeper) throws IOException,
// SolrServerException {
// this(solrZookeeper, (String) null);
// }
//
// public SolrInput(final String solrZookeeper, String collection) throws
// IOException, SolrServerException {
// this(solrZookeeper, collection, new SolrQuery());
// }
//
// public SolrInput(final String solrZookeeper, final SolrQuery filter) throws
// IOException, SolrServerException {
// this(solrZookeeper, null, filter);
// }
//
// public SolrInput(final String solrZookeeper, String collection, final
// SolrQuery filter) throws IOException, SolrServerException {
