...
public class Es5NestedQueryHZWA {
	...
	public void init() throws UnknownHostException {
		Settings settings = Settings.builder().put("cluster.name", "hzcominfo").build();
	...
	public void t2() {
		...
		QueryBuilder query = QueryBuilders.nestedQuery("LG", QueryBuilders.termQuery("LG.LGDM_s", "3301060608"),
				ScoreMode.Avg);
	...
	public void n1() {
		...
		// String sql = "select XM_s, keyword(TL.TO_STATION_NAME_s) from " + index + "."
		// + type + " limit 10";
		/** nested in condition */
		/** unary condition */
		// String sql = "select XM_s, keyword(LG.LGDM_s) from " + index + "." + type + "
		// where LG.LGDM_s is not null limit 10"; // TODO: 2018/1/12 pass!
		/** binary condition */
		// String sql = "select XM_s, keyword(LG.LGDM_s) from " + index + "." + type + "
		// where LG.LGDM_s = '3301060608' limit 10";
		// String sql = "select XM_s, keyword(LG.LKZT_FORMAT_s) from " + index + "." +
		// type + " where keyword(LG.LKZT_FORMAT_s) = '离店' limit 10"; // TODO: 2018/1/12
		// no result found!
		// String sql = "select XM_s, keyword(LG.LGDM_s) from " + index + "." + type + "
		// where keyword(LG.LGDM_s) = '3301060608' limit 10"; // TODO: 2018/1/12 no
		// result found!
		// String sql = "select XM_s, keyword(LG.LGDM_s) from " + index + "." + type + "
		// where LG.LGDM_s = '3301060608' limit 10"; // TODO: 2018/1/12 pass !!
		// String sql = "select XM_s, keyword(LG.LGDM_s) from " + index + "." + type + "
		// where LG.LGDM_s like '330106%' limit 10"; // TODO: 2018/1/12 pass!
		// String sql = "select XM_s, keyword(LG.LGDM_s), LG.LDSJ_year_s from " + index
		// + "." + type + " where LG.LDSJ_year_s >= '2013' limit 10"; // TODO: 2018/1/12
		// pass!
		// String sql = "select XM_s, keyword(LG.LGDM_s), LG.LDSJ_year_s from " + index
		// + "." + type + " where LG.LDSJ_year_s > '2013' limit 10"; // TODO: 2018/1/12
		// pass!
		// String sql = "select XM_s, keyword(LG.LGDM_s), LG.LDSJ_year_s from " + index
		// + "." + type + " where LG.LDSJ_year_s < '2009' limit 10"; // TODO: 2018/1/12
		// pass!
		/** ternary condition */
		// String sql = "select XM_s, keyword(LG.LGDM_s), LG.LDSJ_year_s from " + index
		// + "." + type + " where LG.LDSJ_year_s between '2001' and '2002' limit 10"; //
		// TODO: 2018/1/12 pass!
		/** multiple condition */
		// String sql = "select XM_s, keyword(LG.LGDM_s), LG.LDSJ_year_s from " + index
		// + "." + type + " where LG.LDSJ_year_s in ('2011', '2012') limit 10"; // TODO:
		// 2018/1/12 pass!
		// String sql = "select XM_s, keyword(LG.LGDM_s), LG.LDSJ_year_s from " + index
		// + "." + type + " where LG.LDSJ_year_s in ('1999', '2000', '2001', '2002')
		// limit 10"; // TODO: 2018/1/12 pass!
		/** nested in order */ // TODO: 2018/1/12 not support for now
		// String sql = "select XM_s, keyword(LG.LGDM_s), LG.LDSJ_year_s from " + index
		// + "." + type + " order by LG.LDSJ_year_s limit 10"; // TODO: 2018/1/12 pass!
	...
	public void g1() {
		...
		requestBuilder.setIndices(index);
		requestBuilder.setTypes(type);
		// QueryBuilder query = QueryBuilders.nestedQuery("LG",
		// QueryBuilders.termQuery("LG.LGDM_s", "3301060608"), ScoreMode.Avg);
		// requestBuilder.setQuery(query);
		// AggregationBuilder aggBuilder =
		// AggregationBuilders.count("MZ_s_count").field("MZ_s");
		// AggregationBuilder aggBuilder =
		// AggregationBuilders.count("XB_s_count").field("XB_s.keyword");
		AggregationBuilder aggBuilder;
		...
		AggregationBuilder a3 = AggregationBuilders.nested("nested_3", "LG")
				.subAggregation(AggregationBuilders.terms("term_1").field("LG.SSXQ_CODE6_s").subAggregation(a2));
		AggregationBuilder a4 = AggregationBuilders.nested("nested_4", "LG")
				.subAggregation(AggregationBuilders.terms("term_2").field("LG.RZSJ_year_s").subAggregation(a3));
		aggBuilder = a4;
	...
	public void n2() {
		/** nested in group by */
		// String sql = "select count(MZ_s) from " + index + "." + type + " group by
		// MZ_s";
		String sql = "select count(MZ_s) from " + index + "." + type
				+ " group by XB_s, MZ_s"; /**
											 * for agg test String sql = "select XM_s from " + index + "." + type + "
											 * where XB_s = '1' and MZ_s = '08'";
											 */

		// String sql = "select count(LG.LGDM_s.keyword) from " + index + "." + type + "
		// group by LG.LGDM_s"; // String sql = "select XM_s, LG.LGDM_s from " + index +
		// "." + type + " where LG.LGDM_s = '3301032076'"; // 得到两条结果，值为3301032076共55条

		// String sql = "select count(LG.SSXQ_CODE6_s) from " + index + "." + type + "
		// group by LG.RZSJ_year_s, LG.SSXQ_CODE6_s"; // TODO: 2018/1/12 pass!
		JsonObject json = SqlExplainer.explain(sql);
		SearchRequestBuilder requestBuilder = client.prepareSearch("");
		System.out.println("============== explainResult =======================");
		System.out.println(json);
